...
async def get_current_user_id(
    ...
    user = await get_current_user_from_token(request, background_tasks, authorization)
...
async def get_current_user_ids(
    ...
    return await get_current_user_from_token(request, background_tasks, authorization)
